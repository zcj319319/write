...
write_spi_reg(0x10,0x8f,0xb4)
write_spi_reg(0x10,0x99,0xb4)
write_spi_reg(0x10,0xa3,0xb4)
write_spi_reg(0x10,0xad,0xb4)
write_spi_reg(0x10,0xb7,0xb4)
write_spi_reg(0x10,0xc1,0xb4)
write_spi_reg(0x10,0xcb,0xb4)
write_spi_reg(0x10,0xd5,0xb4)

####fine tune
write_spi_reg(0x10,0x8e,0x14)
write_spi_reg(0x10,0x98,0x14)
write_spi_reg(0x10,0xa2,0x14)
write_spi_reg(0x10,0xac,0x14)
write_spi_reg(0x10,0xb6,0x14)
write_spi_reg(0x10,0xc0,0x14)
write_spi_reg(0x10,0xca,0x14)
write_spi_reg(0x10,0xd4,0x14)
