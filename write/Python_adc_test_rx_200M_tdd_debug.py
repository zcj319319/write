...
############################################ power on control #############################
write_spi_reg(0x80,0x00)
write_spi_reg(0x82,0x00)
write_spi_reg(0x84,0x22)  # adc clock delay set
...
write_spi_reg(0x8e,0x3f)  # int power set
...
write_spi_reg(0xac,0x84)  # quantizer power set & dem set
...
# write_spi_reg(0xb0,0x84)  # set orx for rx 200M cali
#
...
# nRet = ControlSPI.VSI_WriteReadBytes(ControlSPI.VSI_USBSPI, 0, 0, write_buffer, 4, read_buffer, 1)
#
# write_spi_reg(0xb0,0x04)  # reset to rx 200M
#
...
write_spi_reg(0x94,0x4e)  #ct cali,
write_spi_reg(0x96,0xc1)  #vref,org:cd,need add 128
write_spi_reg(0xb0,0x0c)  #cap_t
write_spi_reg(0xb2,0x00)  #cap_t
write_spi_reg(0xb4,0xff)  #cap_t

# ########## ln1v off case ############
# write_spi_reg(0xae,0x04)
# write_spi_reg(0x80,0xac) # reset state
# write_spi_reg(0x86,0x40) # bit[2] for 1n1v
# write_spi_reg(0x88,0x00)
# write_spi_reg(0x8a,0x20)
# write_spi_reg(0x8c,0x00)
# write_spi_reg(0x92,0x00) # 02 for man set cap/ 00 for auto cali
# sleep(0.01)
# write_spi_reg(0x80,0xa0)

# ### debug, dem opt
# write_spi_reg(0x80,0xe0)  # 0xe0 for dem on; 0xa0 for dem off
...
# sleep(0.01)
# write_spi_reg(0x80,0x80)  # clock sync
...
# exit()
############### debug mode, manual control, switch off ln1v ###################
write_spi_reg(0x80,0x6e) # sleep state
write_spi_reg(0x86,0x40) # bit[2] for 1n1v
write_spi_reg(0x88,0x3c) # int pd related
write_spi_reg(0x8a,0xf0)
write_spi_reg(0x8c,0x00)
write_spi_reg(0x90,0x77)
write_spi_reg(0x92,0x02) # 02 for man set cap/ 00 for auto cali
write_spi_reg(0xae,0x14) # [5:4] for sleep mode set
...
write_buffer[4] = 0x80   #sleep to setup
write_buffer[5] = 0x6c   #
write_buffer[6] = 0x88
write_buffer[7] = 0x00
write_buffer[8] = 0x86
write_buffer[9] = 0x44
write_buffer[10] = 0x8a
write_buffer[11] = 0x20
# write_buffer[10] = 0x90 # setup hold time
# write_buffer[11] = 0x47
write_buffer[12] = 0x90
write_buffer[13] = 0x47
# write_buffer[14] = 0x90
# write_buffer[15] = 0x47
write_buffer[14] = 0x80 # setup to work
write_buffer[15] = 0x60
# write_buffer[16] = 0x88
# write_buffer[17] = 0x00
nRet = ControlSPI.VSI_WriteReadBytes(ControlSPI.VSI_USBSPI, 0, 0, write_buffer, 16, read_buffer, 2)


### idle time between sleep/work
# write_mem_reg(0x00,0x00,0x00,0x00,0x00,0x00)
# write_mem_reg(0x00,0x00,0x00,0x00,0x00,0x00)
# write_mem_reg(0x00,0x00,0x00,0x00,0x00,0x00)
# write_mem_reg(0x00,0x00,0x00,0x00,0x00,0x00)
# write_mem_reg(0x00,0x00,0x00,0x00,0x00,0x00)
