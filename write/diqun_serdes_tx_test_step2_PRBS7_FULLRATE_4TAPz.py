...
write_spi_reg(0x10,0x91,0x78)
write_spi_reg(0x10,0x9b,0x78)
write_spi_reg(0x10,0xa5,0x78)
write_spi_reg(0x10,0xaf,0x78)
write_spi_reg(0x10,0xb9,0x78)
write_spi_reg(0x10,0xc3,0x78)
write_spi_reg(0x10,0xcd,0x78)
write_spi_reg(0x10,0xd7,0x78)
