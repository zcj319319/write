...
write_spi_reg(0x10,0x90,0x38)         
write_spi_reg(0x10,0x9a,0x38)
write_spi_reg(0x10,0xa4,0x38)
write_spi_reg(0x10,0xae,0x38)
write_spi_reg(0x10,0xb8,0x38)
write_spi_reg(0x10,0xc2,0x38)
write_spi_reg(0x10,0xcc,0x38)
write_spi_reg(0x10,0xd6,0x38)

####maincursor and precursor weight
write_spi_reg(0x10,0x8f,0xd4)
write_spi_reg(0x10,0x99,0xd4)
write_spi_reg(0x10,0xa3,0xd4)
write_spi_reg(0x10,0xad,0xd4)
write_spi_reg(0x10,0xb7,0xd4)
write_spi_reg(0x10,0xc1,0xd4)
write_spi_reg(0x10,0xcb,0xd4)
write_spi_reg(0x10,0xd5,0xd4)
