...
write_spi_reg(0x11,0x42,0x03) #### TEMP_SLLP[4:0], TEMP_CLK_SEL,TEMP_BY_SLLP[11:10]
write_spi_reg(0x11,0x43,0x70) #### SLLP_CLK_DIV[0],TEMP_SLLP[11:5]
write_spi_reg(0x11,0x44,0xf0) #### SLLP_CLK_DIV[8:1]
write_spi_reg(0x11,0x45,0x47) #### IND_SW_MODE, IND SW, SLLP_STEP[2:0],SLLP_CLK_DIV[11:9];0x50 VCO high speed.
write_spi_reg(0x11,0x46,0x20) #### REF_DIVR[3:0],KVCO_SLOW,KVCO[2:0]
write_spi_reg(0x11,0x49,0xc0) #### LPF Res[0]=0,LPF_C2[2:0]=4，FBC_DIVR[11:8]
write_spi_reg(0x11,0x4a,0x51) #### TEST_EN,LOCK_DLY_SEL,PLL_POSTDIV2,POSTDIV_EN, ICP[2:0]=3,LPF_Res[1]=0,
#write_spi_reg(0x11,0x4a,0x56) #### Enable post divider. ICP[2:0]=3,LPF_Res[1]=0,
write_spi_reg(0x11,0x4d,0xcf) #### VGNSEL_POST[0],VGNSEL_FBC[2:0],VGNSEL_E2C[2:0],VGNSEL,DAC_LOGIC
write_spi_reg(0x11,0x4d,0x93) #### VGNSEL_VCO[2:0],VGNSEL_RFC,VGNSEL_POST[2:1].
