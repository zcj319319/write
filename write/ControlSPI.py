...
if(platform.system()=="Windows"):
    if "64bit" in platform.architecture():
        GinkgoLib = windll.LoadLibrary(r"C:\Users\Administrator\Desktop\阶段二\write\write\lib\windows\64bit\Ginkgo_Driver.dll")
    else:
        GinkgoLib = windll.LoadLibrary(r"C:\Users\Administrator\Desktop\阶段二\write\write\lib\windows\64bit\Ginkgo_Driver.dll")
elif(platform.system()=="Darwin"):
    GinkgoLib = cdll.LoadLibrary("libGinkgo_Driver.dylib")
