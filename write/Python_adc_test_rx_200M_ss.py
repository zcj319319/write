...
write_spi_reg(0x84,0x00)  # adc clock delay set
write_spi_reg(0x86,0x40)  # set idac cali range, 00,40,80
write_spi_reg(0x88,0x00)  # I path ldo value set
write_spi_reg(0x8a,0x20)  # od_sw_rstn set & mode set
write_spi_reg(0x8e,0x15)  # int power set,optional 0x00,0x15,0x2a,0x3f
...
write_spi_reg(0x94,0x4e)  #ct cali, optional 4e/c1;org:30,ba
write_spi_reg(0x96,0xc1)  #vref,org:cd,need add 128,set1:ba
