...
write_spi_reg(0x10,0x7d,0x06)  ## refclk divider div 0x0c=12, 250MHz

write_spi_reg(0x11,0x46,0x28) ####
####PLL FBC divider by 60
write_spi_reg(0x11,0x48,0x012) ####div  by 24
...
write_spi_reg(0x11,0x45,0x07) #### IND_SW_MODE, IND SW, SLLP_STEP[2:0],SLLP_CLK_DIV[11:9];0x50 VCO high speed. 0x10 vco low speed
write_spi_reg(0x11,0x46,0x2b) #### REF_DIVR[3:0],KVCO_SLOW,KVCO[2:0]
write_spi_reg(0x11,0x49,0x40) #### LPF Res[0]=0,LPF_C2[2:0]=4，FBC_DIVR[11:8]
write_spi_reg(0x11,0x4a,0x52) #### Enable post divider. ICP[2:0]=2,LPF_Res[1]=0,
