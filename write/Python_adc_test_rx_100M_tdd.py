...
write_spi_reg(0x84,0x88)  # adc clock delay set,ss corner 44
...
write_spi_reg(0x8e,0x2a)  # int power set
...
write_spi_reg(0xb6,0x08)  # dem clock delay set
...
write_spi_reg(0x92,0x01) # set to 100M case
write_spi_reg(0x8a,0x24) # set to 100M case
...
write_spi_reg(0xb0,0x04)  # reset to rx 100M
...
############################################ offset cali  #############################
write_mem_reg(0x00,0x08,0x00,0x00,0x00,0x1C) # set to 100M mode
write_mem_reg(0x00,0x0C,0x00,0x00,0x00,0x1C) # set to 100M mode
...
write_buffer[6] = 0x00
write_buffer[7] = 0x00
write_buffer[8] = 0x1D # count time 1024:0x1D
nRet = ControlSPI.VSI_WriteReadBytes(ControlSPI.VSI_USBSPI, 0, 0, write_buffer, 9, read_buffer, 2)
...
# write_spi_reg(0x94,0x43)  #ct cali,
# write_spi_reg(0x96,0xc1)  #vref,org:cd

write_spi_reg(0xae,0x12)  # sleep
sleep(0.01)
write_spi_reg(0xae,0x10)  # work
sleep(0.01)
write_spi_reg(0x80,0xc0)  # clock sync

# ### delay control
# write_spi_reg(0x84,0x00)

# ### dem control
# write_spi_reg(0x80,0x80)
...
# write_spi_reg(0xb0,0x04) # [7] for rx/orx select; [2] for od set; [0] for 3.2us/2us select
# sleep(0.01)
