...
write_spi_reg(0x10,0xe1,0x4f)  ##CH0: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c, 2f can used for 7GHz
write_spi_reg(0x10,0xed,0x4f)  ##CH1: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x10,0xf9,0x4f)  ##CH2: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x11,0x05,0x4f)  ##CH3: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x11,0x11,0x4f)  ##CH4: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x11,0x1d,0x4f)  ##CH5: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x11,0x29,0x4f)  ##CH6: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
write_spi_reg(0x11,0x35,0x4f)  ##CH7: reg_dll_go_on, reg_dll_gm_c, reg_dll_delay_c
