...
write_spi_reg(0x10,0x91,0x73)
write_spi_reg(0x10,0x9b,0x73)
write_spi_reg(0x10,0xa5,0x73)
write_spi_reg(0x10,0xaf,0x73)
write_spi_reg(0x10,0xb9,0x73)
write_spi_reg(0x10,0xc3,0x73)
write_spi_reg(0x10,0xcd,0x73)
write_spi_reg(0x10,0xd7,0x73)

####2-tap default settings####
####post1c and post2c weight
write_spi_reg(0x10,0x90,0x35)         
write_spi_reg(0x10,0x9a,0x35)
write_spi_reg(0x10,0xa4,0x35)
write_spi_reg(0x10,0xae,0x35)
write_spi_reg(0x10,0xb8,0x35)
write_spi_reg(0x10,0xc2,0x35)
write_spi_reg(0x10,0xcc,0x35)
write_spi_reg(0x10,0xd6,0x35)

####maincursor and precursor weight
write_spi_reg(0x10,0x8f,0xe4)
write_spi_reg(0x10,0x99,0xe4)
write_spi_reg(0x10,0xa3,0xe4)
write_spi_reg(0x10,0xad,0xe4)
write_spi_reg(0x10,0xb7,0xe4)
write_spi_reg(0x10,0xc1,0xe4)
write_spi_reg(0x10,0xcb,0xe4)
write_spi_reg(0x10,0xd5,0xe4)
