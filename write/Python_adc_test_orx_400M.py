...
write_spi_reg(0x84,0x22)  # adc clock delay set, tt corner 4
...
# write_spi_reg(0x94,0x35)  #ct cali,
# write_spi_reg(0x96,0xaf)  #vref,org:cd,need add 128
...
sleep(0.01)
write_spi_reg(0x80,0xe0)  # clock sync 0xc0 for dem on; 0x80 for dem off
