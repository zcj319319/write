...
### CDR settings
write_spi_reg(0x00,0x29,0X22)
write_spi_reg(0x00,0x2A,0X02)
...
write_spi_reg(0x00,0x03,0x55)  ### F5 means ctle s1 r is set to the lowest.
