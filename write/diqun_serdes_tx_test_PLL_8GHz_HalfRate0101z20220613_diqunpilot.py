...
write_spi_reg(0x10,0xa2,0x00) ####lane0: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xa3,0xc4) ####lane0: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xa4,0x3c) ####lane0: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;

write_spi_reg(0x10,0xac,0x00) ####lane1: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xad,0xc4) ####lane1: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xae,0x3c) ####lane1: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;

write_spi_reg(0x10,0xb6,0x00) ####lane0: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xb7,0xc4) ####lane0: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xb8,0x3c) ####lane0: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;

write_spi_reg(0x10,0xc0,0x00) ####lane1: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xc1,0xc4) ####lane1: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xc2,0x3c) ####lane1: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;

write_spi_reg(0x10,0xca,0x00) ####lane0: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xcb,0xc4) ####lane0: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xcc,0x3c) ####lane0: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;

write_spi_reg(0x10,0xd4,0x00) ####lane1: bit[5:4] post1 cursor fine tune; bit[3:2] main cursor fine tune;
write_spi_reg(0x10,0xd5,0xc4) ####lane1: bit[7:4] main cursor 10-8-4-2; bit[3:0] pre-cursor 2-1-0.5-0.33;
write_spi_reg(0x10,0xd6,0x3c) ####lane1: bit[7:4] post2 cursor 1-1-0.5-0.33; bit[3:0] post1 cursor 4-2-2-1;
