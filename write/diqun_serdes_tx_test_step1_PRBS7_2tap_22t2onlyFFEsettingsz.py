...
write_spi_reg(0x10,0x90,0x34)         
write_spi_reg(0x10,0x9a,0x34)
write_spi_reg(0x10,0xa4,0x34)
write_spi_reg(0x10,0xae,0x34)
write_spi_reg(0x10,0xb8,0x34)
write_spi_reg(0x10,0xc2,0x34)
write_spi_reg(0x10,0xcc,0x34)
write_spi_reg(0x10,0xd6,0x34)
