...
write_spi_reg(0x11,0x48,0x18) ####div  by 24
...
write_spi_reg(0x11,0x3d,0x30) #### FREQ_LOAD[13:6]
...
write_spi_reg(0x11,0x40,0x10) #### TEMP_BY_SLLP[1:0],FREQ_CALI_STEP2_SIZE[6:1]
write_spi_reg(0x11,0x41,0x00) #### TEMP_BY_SLLP[9:2]
write_spi_reg(0x11,0x42,0x02) #### TEMP_SLLP[4:0], TEMP_CLK_SEL,TEMP_BY_SLLP[11:10]
write_spi_reg(0x11,0x43,0xff) #### SLLP_CLK_DIV[0],TEMP_SLLP[11:5]
...
write_spi_reg(0x11,0x46,0x29) #### REF_DIVR[3:0],KVCO_SLOW,KVCO[2:0]
write_spi_reg(0x11,0x49,0x40) #### LPF Res[0]=0,LPF_C2[2:0]=4，FBC_DIVR[11:8]
write_spi_reg(0x11,0x4a,0x50) #### Enable post divider. ICP[2:0]=5,LPF_Res[1]=0,
