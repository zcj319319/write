...
write_spi_reg(0x84,0x22)  # adc clock delay set, ss corner 22, tt corner 88?
...
sleep(0.01)
write_spi_reg(0x80,0xe0)  # clock sync
...
# write_spi_reg(0x92,0x01) # 02 for man set cap/ 00 for auto cali
# sleep(0.01)
