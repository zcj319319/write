...
####4-tap default settings####
####post1c and post2c weight
write_spi_reg(0x10,0x90,0x3e)         
write_spi_reg(0x10,0x9a,0x3e)
write_spi_reg(0x10,0xa4,0x3e)
write_spi_reg(0x10,0xae,0x3e)
write_spi_reg(0x10,0xb8,0x3e)
write_spi_reg(0x10,0xc2,0x3e)
write_spi_reg(0x10,0xcc,0x3e)
write_spi_reg(0x10,0xd6,0x3e)

####maincursor and precursor weight
write_spi_reg(0x10,0x8f,0x98)
write_spi_reg(0x10,0x99,0x98)
write_spi_reg(0x10,0xa3,0x98)
write_spi_reg(0x10,0xad,0x98)
write_spi_reg(0x10,0xb7,0x98)
write_spi_reg(0x10,0xc1,0x98)
write_spi_reg(0x10,0xcb,0x98)
write_spi_reg(0x10,0xd5,0x98)
