...
write_spi_reg(0x94,0x4e)  #ct cali, org:30/ba;rec: 4e/c1
...
### debug, dem opt
write_spi_reg(0x80,0xa0)  # 0xe0 for dem on; 0xa0 for dem off
...
# write_spi_reg(0xb0,0x0d) # [7] for rx/orx select; [2] for od set; [0] for 3.2us/2us select
# sleep(0.01)
### case2 sleep mode 1 to work
write_spi_reg(0xae,0x12)
write_spi_reg(0xb0,0x0c) # [7] for rx/orx select; [2] for od set; [0] for 3.2us/2us select
...
# write_buffer[4] = 0x8a   # refer to up
# write_buffer[5] = 0x20   #
